...
In the future it may be possible to write modules in other languages, but it is not recommended as it will reduce the chance of getting others in the community to contribute features and fixes. If you are interested in doing this then reach out and we can work together on creating an alternate framework for the language you are using.
